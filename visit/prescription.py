...
x = 185
pr1.drawString(*coord(10,x, mm), l3)

### Line 4 Mon-Fri AM line
pr1.setFont('Helvetica', 10)
x = 183
pr1.drawString(*coord(10, x, mm), 'Mon. - Fri. :')
...
pr1.setFont('Helvetica', 10)
pr1.drawString(*coord(90, x-2, mm), 'NOPH')
pr1.drawString(*coord(90, x-4, mm), 'Holy Child Hospital')

### Line 6 Sat AM line
pr1.setFont('Helvetica', 10)
x = 174
pr1.drawString(*coord(10, x, mm), 'Saturday :')
pr1.drawString(*coord(30, x, mm), l4)

### Line 7 Telephone
x = 171
pr1.drawString(*coord(10, x, mm), 'Tel. No. :')
pr1.drawString(*coord(30, x, mm), l6)

### Draw line between Doctor & patient
pr1.line(10, x-2, 130, x-2)
pr1.line(10, x-3, 130, x-3)
